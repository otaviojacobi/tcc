...
def run_single_sim_options(sims, smooth, cputc):
    ...
    env = GridWorld(env_map)
    env.add_option(GridWorldOption((5,46), {'all'}, 5))
    env.add_option(GridWorldOption((32,43), {'all'}, 6))
    env.add_option(GridWorldOption((30,10), {'all'}, 7))
...
def run_single_sim_doors(sims, smooth, cputc):
    ...
    env.add_option(GridWorldOption((3,28),  set(first_room_pos + second_room_pos + [(14,10)] + [(14,45)]), 5))
    env.add_option(GridWorldOption((14,10),  set(first_room_pos + third_room_pos + [(3,28)] + [(30,28)]), 6))
    env.add_option(GridWorldOption((14,45), set(second_room_pos + fourth_room_pos + [(3,28)] + [(30,28)]), 7))
    env.add_option(GridWorldOption((30,28), set(third_room_pos + fourth_room_pos + [(14,10)] + [(14,45)]), 8))
