...
public class ExecSync extends Exec
{
    ...
    public static void runGame(boolean visual, int delay)
    {
        ...
        while(!m_game.isEnded())
        {
            ...
            if(spent > PTSPConstants.TIME_ACTION_DISQ)
            {
                ...
                {
                    System.out.println("Time exceeded: " + spent);
                    actionToExecute = 0;
                }
        ...
        for(int m = 0; moreMaps && m < m_mapNames.length; ++m)
        {
            ...
            for(int i=0;i<trials;i++)
            {
                ...
                while(!m_game.isEnded())
                {
                    ...
                    {
                        System.out.println("Aborting game: " + exceeded);
                        actionToExecute = 0;
                        numGamesPlayed--;
                        m_game.abort();
                        ...
                        {
                            System.out.println("Time exceeded: " + exceeded);
                            actionToExecute = 0;
                        }
    ...
    public static void main(String[] args)
    {
        ...
        m_mapNames = new String[]{"/home/diego/phd/svn/diego/PTSP_League/framework/maps/league2/ptsp_league_map01.map"};  //Set here the name of the map to play in.
        /*m_mapNames = new String[]{"maps/StageB/ptsp_map04.map","maps/StageB/ptsp_map07.map","maps/StageB/ptsp_map10.map",
                "maps/StageB/ptsp_map12.map","maps/StageB/ptsp_map15.map","maps/StageB/ptsp_map18.map",
                "maps/StageB/ptsp_map20.map","maps/StageB/ptsp_map23.map","maps/StageB/ptsp_map27.map",
                "maps/StageB/ptsp_map29.map","maps/StageB/ptsp_map34.map","maps/StageB/ptsp_map37.map",
                "maps/StageB/ptsp_map42.map","maps/StageB/ptsp_map43.map","maps/StageB/ptsp_map46.map",
                "maps/StageB/ptsp_map48.map","maps/StageB/ptsp_map51.map","maps/StageB/ptsp_map53.map",
                "maps/StageB/ptsp_map57.map","maps/StageB/ptsp_map64.map"}*/
